...
export default function Login() {
  const { signInWithGoogle, signInAsMember, currentUser, currentMember } = useAuth();
      ...
      <div className="max-w-sm w-full theme-card p-8 space-y-8 text-center">
        ...
        {loginType === 'member' ? (
          ...
          <div className="pt-4 space-y-4">
             <p className="text-sm text-text-muted mb-4">শুধুমাত্র অনুমোদিত অ্যাডমিনদের জন্য</p>
             <Button onClick={signInWithGoogle} className="w-full text-base py-6 border" variant="outline" size="lg">
